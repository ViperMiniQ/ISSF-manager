...
class ImageCrop(tk.Frame):
    ...
    def set_save_location(self, location: str):
    ...
    def save_copped(self):
        ...
        #    self.cropped_image.save(self.save_location + self.filename + self.file_extension)
        self.destroy()
...
class ImageCropHelp(tk.Toplevel):
    def __init__(self, parent):
        ...
        self.help_text = ("Selection box will appear hovering over the image and the part\n"
                          "within the box will show as a cropped image in the top right corner.\n"
                          "\n"
                          "Left-clicking on a selection you want to crop, the top right image\n"
                          "will become frozen and you can than save the cropped picture.\n"
                          "\n"
                          "Left-clicking again the main image will unfreeze the hover box\n"
                          "and you can continue with the new selection.")
        ...
        self.lbl_help.pack(expand=True, fill="both")


class ImageCropToplevel(tk.Toplevel):
    def __init__(self, parent):
        super().__init__(parent)

        self.frame_main = ImageCrop(self)
